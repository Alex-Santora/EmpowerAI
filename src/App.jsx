...
function TikTokLogo() {
  return (
    <svg viewBox="0 0 448 512" role="img" aria-label="TikTok">
      <path
        fill="currentColor"
        d="M448 209.9a210.1 210.1 0 0 1-122.8-39.3v178.8A162.6 162.6 0 1 1 185 188.8v89.4a74.6 74.6 0 1 0 52.2 71.2V0h88a121.2 121.2 0 0 0 1.9 22.2 122.2 122.2 0 0 0 53.9 80.2 121.4 121.4 0 0 0 67 20.1Z"
      />
    </svg>
  );
}
function InstagramLogo() {
  return (
    <svg viewBox="0 0 448 512" role="img" aria-label="Instagram">
      <path
        fill="currentColor"
      ...
      <section className="commit">
        <div className="shell commitGrid">
          ...
          <div className="socialHub">
            <div className="socialHubHeading">
              <span>FOLLOW THE BUILD</span>
              <b>Learn with us beyond the site.</b>
            </div>
            <div className="socialLinks">
              <a
                ...
                aria-label="Follow FutureWithAI on TikTok at futurewithai.dev"
              >
                <i aria-hidden="true"><TikTokLogo /></i>
                <span><small>TikTok</small><b>@futurewithai.dev</b></span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow FutureWithAI on Instagram at futurewithai.dev"
              >
                <i aria-hidden="true"><InstagramLogo /></i>
                <span><small>Instagram</small><b>@futurewithai.dev</b></span>
                <ArrowUpRight aria-hidden="true" />
              </a>
            </div>
          </div>
